            ...
            <div className="card product_item">
                <div className="body">
                    <div className="cp_img" >
                        ...
                        <div className="hover">
                            <a href="javascript:void(0);" className="btn btn-primary btn-sm waves-effect"><i className="zmdi zmdi-plus"><b>Add Cart</b></i></a>
                            <a href="javascript:void(0);" className="btn btn-primary btn-sm waves-effect"><i className="zmdi zmdi-shopping-cart"><b>Buy Now</b></i></a>
                        </div>
                    </div>
                    <div className="product_details">
                        <h5><a href="ec-product-detail.html">Simple Black Clock</a></h5>
