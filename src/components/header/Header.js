                ...
                <div className="container">
                    <div className="containt_main">
                        <div id="mySidenav" className={opennav} style={{width: "250px;"}}>
                            ...
                            <a href=""><Link to="/AddProduct">AddProduct</Link></a>
                        </div>
                        ...
                        <div className="dropdown">
                            ...
                            <Link to="/Fashion">  <a className="dropdown-item" >Fashion</a> </Link>
                            <Link to="/Shoes">    <a className="dropdown-item" >Shoes</a> </Link>
